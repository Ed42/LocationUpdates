 ...
 * <p/>
 * {@link #getLocation} gets the current location using the Location Services getLastLocation() function. {@link
 * #getAddress} calls geocoding to get a street address for the current location. {@link #startUpdates} sends a request
 * to Location Services to send periodic location updates to the Activity. {@link #stopUpdates} cancels previous
...
public class MainActivity extends FragmentActivity implements
	...
	/**
	 * Invoked by the "Get Address" button. Get the address of the current location, using reverse geocoding. This only
	 * works if a geocoding service is available.
	 *
	 * @param v The view object associated with this method, in this case a Button.
	 */
	...
	/**
	 * An AsyncTask that calls getFromLocation() in the background. The class uses the following generic types:
	 * Location
	 * - A {@link android.location.Location} object containing the current location, passed as the input parameter to
	 * doInBackground() Void     - indicates that progress units are not used by this subclass String   - An address
	...
	protected class GetAddressTask extends AsyncTask<Location, Void, String> {
		...
		/**
		 * A method that's called once doInBackground() completes. Set the text of the UI element that displays the
		 * address. This method runs on the UI thread.
		 */
		@Override
